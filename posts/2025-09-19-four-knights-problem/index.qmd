...
![FIG.1: Chessboard and positions of the 4 knights. [Credit: Lovro Šubelj]](fkp.png){width=33%}
...
![FIG.2: The solution with 40 moves.](fkp-board.gif){width=33%}
...
![FIG.3: Graph representation of the chessboard.](fkp-graph.png){width=100%}
...
![FIG.4: Animation of the 40 moves in both the chessboard and the knight-move graph.](fkp.gif)
