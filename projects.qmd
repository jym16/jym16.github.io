...
Physical networks are networks of tangible objects, i.e., nodes and edges are embedded in a physical space under physical constraints (e.g., volume exclusion) [[@dehmamy2018structural], [@liu2021isotopy], [@posfai2024impact], [@pete2024physical], [@blagojevic2024three], [@glover2024measuring]]. 
Examples of physical networks include biological neural networks, vascular networks, porous media, granular materials, to name a few.
...
Putting aside the issue of observability of network fractality in real-world (finite) networks, networks with fractal structure exhibit intrigueing properties, such as the long-range degree correlations in the form of *hub repulsion* [@rozenfeld2008fractal].
